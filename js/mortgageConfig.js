...
var dims = {
    ...
    "orig_yr":{"display":"Vintage (yr)","value":21},
    "sec_county":{"display":"County","value":22},
    };
...
var dimOrder = {
    ...
    "loan_size_band":["0-<5k","5K-<10K","10K-<20K","20K-<50K","50K-<100K","100K-<250K","250K-<500K","500K-<1M","1M-high"],
    "dpd_band":["720+","360-720","180-360","90-180","60-90","30-60","0-30","UTD"],
    ...
    "sale":["N","Y"],
    "orig_yr":[2001,2002,2003,2004,2005,2006,2007,2008,2009,2010,2011,2012,2013,2014,2015],
    "sec_county":[]
}
...
var filterDimsNew = {
        ...
        "orig_yr":{"colours":null},
        "sec_county":{"colours":null}
    };
