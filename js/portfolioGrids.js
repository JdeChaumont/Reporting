...
rptDef1 = function() {
    return encodeDef({
        ...
        rows : [ 	{ display : "" }, //need to reserve space
                    ...
                    { display : "360+", key : { npl : "Y", dpd_band : "360<" } },
                    { display : " ", css : "blank" },
...
rptDef4 = function() {
    return encodeDef({
        ...
        rows : [ 	{ display : "" }, //need to reserve space
                    ...
                    { display : "Rev", key : { repay_type : "Rev" } },
                    { display : " ", css : "blank" },
                    { display : "Loan Size", css : "blank" },
                    { display : " ", css : "blank" },
                    { display : "0-<1K", key : { loan_size_band : "0-<1k" } },
                    { display : "1K-<2K", key : { loan_size_band : "1K-<2K" } },
                    { display : "2K-<5K", key : { loan_size_band : "2K-<5K" } },
